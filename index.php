 ...
 * @copyright           Copyright (C) 2001 - 2016 ITDC, JSC. All rights reserved.
...
$folder = pathinfo(dirname(__FILE__), PATHINFO_FILENAME);
$url = $scheme . '://' . $_SERVER['HTTP_HOST'] . '/' . $folder . '/checkmodrewriteitdc.php';
?>
...
abstract class Checker
{
    ...
    protected static $required_list = [
        'php'                => [
            'id'          => 'check_php',
            'title'       => 'PHP Extension',
            'method'      => 'checkPHP',
    ...
    protected static $recommended_list = [
        'php'                => [
            'id'       => 'check_php',
            'title'    => 'PHP Extension',
            'method'   => 'checkPHP',
    ...
    public static function check($mode, $level = 1)
    {
        ...
        $check = call_user_func(['Checker', $test['method']]);
    ...
    public static function checkGoogleConnect()
    {
        ...
        if (empty($return)) {
            ...
            $urls = ['https://accounts.google.com', 'https://www.googleapis.com'];
...
function is_debug_mode()
{
    ...
    $arr = ['92.241.86.122', '95.104.105.5'];
